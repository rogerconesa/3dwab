...
function(declare, _WidgetBase, lang, html, domClass, on, Evented, keys, jimuUtils) {
  return declare([_WidgetBase, Evented], {
    ...
    postCreate: function(){
      ...
      this.labelNode = html.create('div', {
        ...
        innerHTML: jimuUtils.sanitizeHTML(this.label) || ""
      }, this.domNode);
      if(this.checked){
    ...
    setLabel: function(label){
      label = label || "";
      this.label = label;
      this.labelNode.innerHTML = jimuUtils.sanitizeHTML(this.label);
      this._udpateLabelClass();
    },
