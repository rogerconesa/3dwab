  ...
  function(declare, lang, array, dojoConfig, Deferred, topic, dojoJson, esriRequest, jimuUtils,
    ...
    var PortalClass = declare([], {
      ...
      loadSelfInfo: function() {
        ...
        if(this.isValidCredential()){
          args.query.token = this.credential.token;
        }
        esriRequest(this.selfUrl, args).then(lang.hitch(this, function(result) {
      ...
      getSigninSettingsOfSelfInfo: function() {
        ...
        if (this.isValidCredential()) {
          ...
          esriRequest(url, args).then(lang.hitch(this, function(result) {
      ...
      queryItems: function(params) {
        ...
        if (params) {
          query = lang.mixin(query, params);
        }

        if (this.isValidCredential()) {
          query.token = this.credential.token;
        }
      ...
      getItemData: function(itemId) {
        ...
        esriRequest(itemDataUrl, args).then(lang.hitch(this, function(result){
          def.resolve(result.data);
        }), lang.hitch(this, function(err){
          def.reject(err);
        }));
      ...
      queryGroups: function(params) {
        ...
        esriRequest(groupUrl, {
          responseType: 'json',
          query: query,
          callbackParamName: 'callback'
        }).then(lang.hitch(this, function(result) {
          var groupsResponse = result.data;
      ...
      _getUser: function(userId) {
        ...
        if(this.isValidCredential()){
          args.query.token = this.credential && this.credential.token;
        }
        esriRequest(userUrl, args).then(lang.hitch(this, function(result) {
    ...
    var PortalUser = declare([], {
      ...
      getContent: function() {
        ...
        var def = new Deferred();
        esriRequest(contentUrl, args).then(lang.hitch(this, function(result){
          def.resolve(result.data);
        }), lang.hitch(this, function(err){
          def.reject(err);
        }));
      ...
      getTags: function() {
        ...
        esriRequest(userTagsUrl, args).then(lang.hitch(this, function(result){
          def.resolve(result.data);
        }), lang.hitch(this, function(err){
          def.reject(err);
        }));
      ...
      addItem: function(args, folderId) {
        ...
        if (this.isValidCredential()) {
          ...
          if (args) {
            query = lang.mixin(query, args);
          }
          var url = portalUrlUtils.getAddItemUrl(this.portalUrl, this.username, folderId);
          esriRequest(url, {
            responseType: 'json',
            callbackParamName: 'callback',
            query: query,
      ...
      getItemById: function(_itemId, folderId) {
        ...
        esriRequest(url + '/' + _itemId, args).then(lang.hitch(this, function(result) {
          var item = result.data;
          item.portalUrl = this.portalUrl;
          item.credential = this.credential;
          item.portal = this;
      ...
      shareItem: function(args, _itemId, folderId) {
        ...
        if (this.isValidCredential()) {
          var url = portalUrlUtils.shareItemUrl(this.portalUrl, this.username, _itemId, folderId);
          var params = {
            responseType: 'json',
            callbackParamName: 'callback',
            query: {
          ...
          if (args) {
            if(args.content && !args.query){
              args.query = args.content;
            }
            params.query = lang.mixin(params.query, args);
          }

          esriRequest(url, params).then(lang.hitch(this, function(result) {
            def.resolve(result.data);
          }), lang.hitch(this, function(err) {
            console.error(err);
            def.reject(err);
      ...
      updateItem: function(itemId, args) {
        ...
        if (this.isValidCredential()) {
          this.portal.getItemById(itemId).then(lang.hitch(this, function(item) {
            ...
            var url = portalUrlUtils.getUpdateItemUrl(this.portalUrl, this.username, itemId, folder);
            esriRequest(url, {
              responseType: 'json',
              callbackParamName: 'callback',
              timeout: 100000,
